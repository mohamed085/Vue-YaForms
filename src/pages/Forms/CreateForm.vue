<template>
  <div :class="'home animate__animated animate__fadeIn ' + form.styleTheme + ' ' + form.fontFamily ">
    ...
    <div v-else>
      ...
      <div v-else-if="getLang === 'ar'" class="main-content en animate__animated animate__backInRight ar">
        <base-spinner v-if="isLoading"></base-spinner>
        ...
        <div v-else class="container">
          ...
          <div class="create-form">
              ...
              <div v-else class="else-type-content">
                ...
                <div v-if="question.type === 'title'" class="title-type-content">
                  <b-form-input
                      ...
                      type="text"
                      v-model="question.description"
                      placeholder="اضف وصفا"></b-form-input>
                </div>
                ...
                <div v-if="question.type === 'video'" class="video-type-content">
                  ...
                  <div v-else class="video-url d-flex">
                    ...
                    ></b-form-input>
                    <b-button @click="addVideo(question.id)" type="reset">أضف فيديو</b-button>
                  </div>
            ...
            <b-button class="btn mb-3" @click="addForm">أضف النموذج</b-button>
          </div>
...
export default {
  ...
  methods: {
    ...
    async addForm() {
      ...
      let url = "https://ya-forms-api.herokuapp.com/API/form";
