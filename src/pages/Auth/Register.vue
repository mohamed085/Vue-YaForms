            ...
            <main class="main-content">
              <div class="main-content-container">
                <div class="personalInfo p-4">
                  ...
                  <p class="valid" v-if="addPasswordAndEmailErrorEn">{{ addPasswordAndEmailErrorEn }}</p>
            ...
            <main class="main-content">
              <div class="main-content-container">
                <div class="personalInfo p-4">
                  ...
                  <p class="valid" v-if="addPasswordAndEmailErrorAr">{{ addPasswordAndEmailErrorAr }}</p>
                  <div v-if="!isLoading" class="form">
                    <div class="form-group">
                      <i class="i fas fa-building"></i>
...
export default {
  ...
  methods: {
    addAccountType(account) {
      ...
      } else if (account === 'BusinessAccount') {
        this.selectAccountType = false;
    ...
    addAccountIndividualAccount() {
      ...
      if (!this.user.phone.match(pattern)) {
        this.individualAccountErrorEn = "Phone number not valid";
        this.individualAccountErrorAr = "رقم الهاتف غير صحيح";
        return
      }
